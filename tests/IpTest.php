...
final class IpTest extends TestCase
{
    public function testBase(): void
    {
        ...
        $this->assertTrue((new IP())->validateString($ipv4_global));
        $this->assertTrue((new IP())->validateString($ipv6_global));
        $this->assertTrue((new IP())->validateString($ipv4_local));
        $this->assertTrue((new IP())->validateString($ipv6_local));
    }
